...
if([ComputerUse.WindowApi]::GetForegroundWindow().ToInt64().ToString() -ne '${prepared.foregroundWindowHandle || '0'}'){throw 'Foreground window changed before native input.'}
